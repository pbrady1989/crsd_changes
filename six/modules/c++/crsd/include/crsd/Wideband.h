 ...
 *
 */
#ifndef __CRSD_WIDEBAND_H__
#define __CRSD_WIDEBAND_H__
#pragma once
...
/*
 * \class Wideband
 * \brief Information about the wideband CRSD data
 */
//  It contains the crsd::Data structure (for channel and vector sizes).
//  Provides methods read wideband data from CRSD file/stream
struct Wideband final
{
     ...
     *
     *  \param pathname Input CRSD pathname
     *  \param metadata Metadata section of CRSD file
     *  \param startWB CRSD header keyword "CRSD_BYTE_OFFSET"
     *  \param sizeWB CRSD header keyword "CRSD_DATA_SIZE"
     */
     ...
     *  \func getFileOffset
     *
     *  \brief Get the byte offset of a specific signal array in the CRSD file
     *
     ...
     *  \func getFileOffset
     *
     *  \brief Get the byte offset of a compressed signal block in the CRSD file
     *
     *  \param channel channel number of signal array
     *
     *  \throw except::Exception If invalid channel, vector or sample
...
private:
    ...
    const crsd::MetadataBase& mMetadata;  // pointer to data metadata
