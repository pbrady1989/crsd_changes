...
#ifndef __crsd_UTILITIES_H__
#define __crsd_UTILITIES_H__
 ...
 *   Valid binary formats are listed in crsd 1.0 spec table 10.2, page 120
 *
 ...
 *  \func getFormatSize
 *
 *  \brief Return parameter size based on valid binary formats table 10.2 crsd1.0 spec
 *
 *  \param format A format string.
 *   Valid binary formats are listed in crsd 1.0 spec table 10.2, page 120
 *
